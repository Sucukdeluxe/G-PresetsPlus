...
- **The room size limit is a tile count, not a side length.** The client says it plainly: *"The maximum number of tiles usable in the floorplan editor is 3025 (55 x 55)"*. A 64×24 plan is 1536 tiles and therefore perfectly legal, while a 56×56 one is 3136 and is not. Checking the sides instead rejects wide, flat builds that would have worked.
